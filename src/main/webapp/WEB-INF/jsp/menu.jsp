	<nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
		<div class="container">
			<a class="navbar-brand" href="principal">Photobreak</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"
						role="button" aria-haspopup="true" aria-expanded="false">Relatório</a>
						<div class="dropdown-menu">
							<a class="dropdown-item" href="#">Parcelas</a> <a
								class="dropdown-item" href="#">Vendas</a>
						</div></li>
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu">
							<a class="dropdown-item" href="usuarios">Usuário</a>
						</div></li>
