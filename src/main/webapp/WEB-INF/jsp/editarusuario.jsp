...
<jsp:include page="menu.jsp" />
	...
	<div class="container">
		...
		<input type="hidden" class="form-control" id="id" name="id" path="id" value="${usuario.id}">
  <div class="form-group">
    <label for="exampleInputEmail1">Nome</label>
    <input type="text" class="form-control" id="nome" name="nome" path="nome" value="${usuario.nome}" placeholder="Seu nome">
  </div>
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="email" name="email" value="${usuario.email}" placeholder="E-mail">
  </div>
  <div class="form-group">
